        ...
        while (true) {
            ...
            while (true) {
                ...
                if (currState.get().isLogicallyDeleted) {
                    if (currState.get().next != null
                            && !current.state().compareAndSet(prevState.get().next.state().get(),
                            new State(currState.get().next,
                                    currState.get().next.state().get().isLogicallyDeleted))) {
                        continue searchStart;
                    }
